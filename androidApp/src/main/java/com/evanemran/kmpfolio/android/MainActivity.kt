        ...
        setContent {
            MyApplicationTheme {
                ...
                Surface(
                    ...
                    Hello("There are only ${daysUntilNewYear()} days left until new year! ")
                }
            }
        }
    }
...
fun Hello(text: String) {
    Text(text = text, style = TextStyle(color = Color.Black, textAlign = TextAlign.Center), modifier = Modifier.fillMaxHeight())
}
